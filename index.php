...
<div class="w3-col l8 s12">
  ...
  <div class="w3-card-4 w3-margin w3-white">
    <img src="ambsuman.jpg" alt="Nature" style="width:100%">
  ...
  <!-- Blog entry -->
  <div class="w3-card-4 w3-margin w3-white">
  <img src="ambar.jpg" alt="Norway" style="width:100%">
    <div class="w3-container">
...
<div class="w3-col l4">
  ...
  <img src="suman1.jpg" style="width:100%">
  ...
  <div class="w3-card w3-margin">
    ...
    <ul class="w3-ul w3-hoverable w3-white">
      <li class="w3-padding-16">
        <img src="suman2.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
